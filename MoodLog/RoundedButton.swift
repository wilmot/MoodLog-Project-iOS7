...
@IBDesignable class RoundedButton: UIButton {
    ...
    @IBInspectable var tapFillColor: UIColor = #colorLiteral(red: 0.2392156869, green: 0.6745098233, blue: 0.9686274529, alpha: 1)
    private var _fillColor: UIColor = #colorLiteral(red: 0, green: 0, blue: 0, alpha: 0)
